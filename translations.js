window.translations = {
  en: {
    ...
    // Home page
    "home.description":
      "It's a creative digital company specializing in modern websites, mobile apps and more.",
    ...
    // Support page
    "support.message":
      "You can write to technical support. You can share about the bug, propose an idea and so on. To write in the support, write to the following email:",
  ...
  ru: {
    ...
    // Support page
    "support.message":
      "Вы можете написать в техническую поддержку. Вы можете сообщить об ошибке, предложить идею и так далее. Для обращения в поддержку напишите на следующий email:",
    "support.email1": "yaroslav.krasulya@gmail.com",
    "support.followup":
      "Если в течение 2 дней нет ответа, пожалуйста, отправьте ваше сообщение снова на тот же email или напишите на другой email:",
    "support.email2": "yaroslav.krasulya@icloud.com",
